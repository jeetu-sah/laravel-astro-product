...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href='{{ url("catalog/product/$product->id/edit") }}' class="d-none d-sm-inline-block btn btn-sm btn-info"><i
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <form action='{{ url("catalog/product/$product->id/upload-image") }}' method="POST">
                        @csrf
                        <div class="row mb-5">
